...
<div class="table-line">
    <div class="table-cell table-cell-position <#if player.state == "OUT_OF_GAME">out</#if>">
        <div class="text-top">${index}.</div>
        <div class="text-bottom">PLATZ</div>
    </div>
    <div class="table-cell-spacer-one"></div>
    <div class="table-cell table-cell-names <#if player.state == "OUT_OF_GAME">out</#if>">
        <div class="names">
    ...
    <div class="table-cell table-cell-chips <#if player.state == "OUT_OF_GAME">out</#if>">
